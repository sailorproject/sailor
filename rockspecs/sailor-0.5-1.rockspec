...
build = {
   ...
   modules = {
      ...
      ['sailor.db.luasql'] = "src/sailor/db/luasql.lua",
   ...
   install = {
      lua = {
         ...
         ["sailor.blank-app.pub.starlight.babel"] = "src/sailor/blank-app/pub/starlight/babel.min.js",
         ["sailor.blank-app.pub.starlight.DOMAPI"] = "src/sailor/blank-app/pub/starlight/DOMAPI.min.js",
         ["sailor.blank-app.pub.starlight.latclient"] = "src/sailor/blank-app/pub/starlight/latclient.js",
         ["sailor.blank-app.pub.starlight.parser"] = "src/sailor/blank-app/pub/starlight/parser.min.js",
         ["sailor.blank-app.pub.starlight.starlight"] = "src/sailor/blank-app/pub/starlight/starlight.min.js",
