...
describe("Testing Admin", function ()
  ...
  it("should not generate model", function()
    local res = test.request('admin',{post={table_name ='asdasd'}})
  ...
  it("should generate model", function()
    ...
    os.remove(path)
    local res = test.request('admin',{post={table_name ='category'}})
  ...
  it("should not generate CRUD", function()
    local res = test.request('admin',{post={model_name ='asdasd'}})
  ...
  it("should generate CRUD", function()
    ...
    local res = test.request('admin',{post={model_name ='category'}})
